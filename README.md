...
```BASH
rhc create-app myapp --env OPENSHIFT_NGINX_VERSION=1.9.12 http://cartreflect-claytondev.rhcloud.com/github/bcphung/openshift-cartridge-nginx
```
...
```BASH
rhc create-app nginx http://cartreflect-claytondev.rhcloud.com/github/bcphung/openshift-cartridge-nginx?commit=develop&r=1
```

Now clone the repository and create a `nginx` folder. Now copy the `usr/compile` directory from [this](https://github.com/bcphung/openshift-cartridge-nginx) repository.
